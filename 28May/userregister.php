...
if(isset($_POST['submit'])) {
  ...
  if($emailVerify === $email){
    $userAllreadyRegistered = "User is allready registered";
  } else {

    $name = $_POST['name']; $email = $_POST['email']; $password = $_POST['password']; $phone = $_POST['phone'];
        ...
        <div class="main-content bg-light w-50 text-dark m-5 p-5">
          <div class="main-content-container">
           ...
           <form action="" method="post">
            <div class=" fs-3 fw-bold d-flex">USER REGISTER FORM</div>
            ...
            <div class="form-group my-2">
              ...
              <input required type="name" name="name" id="name" class="form-control" placeholder="John smith" aria-describedby="helpId">
            </div>
            ...
            <div class="form-group my-2">
              ...
              <input required type="number" name="phone" id="phone" class="form-control" placeholder="8823648343" aria-describedby="helpId">
            </div> 
